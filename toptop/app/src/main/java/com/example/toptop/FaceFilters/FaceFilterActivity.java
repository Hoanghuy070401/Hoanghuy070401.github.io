package com.example.toptop.FaceFilters;
...
import com.example.toptop.FaceFilters.camera.CameraSourcePreview;
import com.example.toptop.FaceFilters.camera.GraphicOverlay;
...
public class FaceFilterActivity extends AppCompatActivity {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode != RESULT_OK) {
            ...
            cameraRecord.setVisibility(View.GONE);
            return;
        }
    ...
    private void recordVideo() {
        ...
        Handler = new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                Toast.makeText(FaceFilterActivity.this, "Recording Stop.....", Toast.LENGTH_SHORT).show();
                Toast.makeText(FaceFilterActivity.this, "You can record only 30 seconds video", Toast.LENGTH_SHORT).show();
            }
        },30000);
    ...
    public String getFilePath() {
        ...
        String filePath;
        if (success) {
            String videoName = ("VietNam" + "TOPTOPKER" + ".mp4");
