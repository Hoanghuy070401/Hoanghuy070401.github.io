...
public class DienThoaiActivity extends AppCompatActivity {
   ...
   boolean isloading = false;
                        ...
                        sanPhamMoiModel -> {
                            if (sanPhamMoiModel.isSuccess()){
                                if (apdaterDt == null){
                                    ...
                                    apdaterDt = new SanPhamApdater(DienThoaiActivity.this,sanPhamList);
                               ...
                               // Toast.makeText(DienThoaiActivity.this, "Đã Hết Sản Phẩm", Toast.LENGTH_SHORT).show();
                                isloading=true;
                            }

                        },
                        throwable -> {
                            //Toast.makeText(DienThoaiActivity.this, "Không kết nối được server", Toast.LENGTH_SHORT).show();
                        }
                ));
    }
    ...
    private void ketnoi() {
        ...
        linearLayoutManager = new LinearLayoutManager(DienThoaiActivity.this,LinearLayoutManager.VERTICAL,false);
